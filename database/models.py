...
class Interlug(models.Model):
    id = models.BigAutoField(primary_key=True)
    id_shape_from = models.ForeignKey('Shapes', models.DO_NOTHING, db_column='id_shape_from', related_name='shape_from')
    id_shape_to = models.ForeignKey('Shapes', models.DO_NOTHING, db_column='id_shape_to', related_name='shape_to')
    created_at = models.DateTimeField(blank=True, null=True)
    updated_at = models.DateTimeField(blank=True, null=True)
